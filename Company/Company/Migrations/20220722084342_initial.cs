        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutForeignKey = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutCompanies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutCompanies_Companies_AboutForeignKey",
                        column: x => x.AboutForeignKey,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RialtoForeignKey = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Rialtos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Rialtos_Companies_RialtoForeignKey",
                        column: x => x.RialtoForeignKey,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutEmployees_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AboutCompanies_AboutForeignKey",
                table: "AboutCompanies",
                column: "AboutForeignKey",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AboutEmployees_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rialtos_RialtoForeignKey",
                table: "Rialtos",
                column: "RialtoForeignKey",
                unique: true);
